...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_LIGHT_GREEN = SET_BG_COLOR_16 + "164;224;148m";
    public static final String SET_BG_COLOR_DARK_GREEN = SET_BG_COLOR_16 + "10;136;66m";
